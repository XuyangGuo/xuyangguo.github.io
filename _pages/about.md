...
+ 2017.10-2019.10, **[NineChapter](https://www.jiuzhang.com/). Teaching Assistant of Machine Learning, Deep Learning and Traditional Algorithms Courses.**
    
  The organization is positioned for online education, covering traditional algorithms, artificial intelligence, etc.    
    Hundreds of students have been helped by us, including the common algorithms and applications of CV, NLP and ML.
...
+ 2020.7 - 2021.6, **Huawei 2012 Lab. Portrait Relighting.**
  ...
  Re-lighting with a selfie image, lighting in any direction. To achieve realistic and available effect, we desgin a two-stage solution 1) 3D reconstruction for diffuse rendering; 2) GAN network fine-tuning.
...
+ I am a lover of technical books. Some Reading Notes and tutorials can be found in my [Blog](https://blog.csdn.net/qq_32071849?type=blog): 
  + [Reading Notes: *Pattern Recognition and Machine Learning (PRML)*](https://blog.csdn.net/qq_32071849/category_9740172.html?spm=1001.2014.3001.5482)
  + [Reading Notes: *The Elements of Statistical Learning, 2nd (ESLII)*](https://blog.csdn.net/qq_32071849/category_10566559.html?spm=1001.2014.3001.5482)
  + [Reading Notes: *Computer Vision - Models, Leanring, and Inference (CVMLI)*](https://blog.csdn.net/qq_32071849/category_9740152.html)
  + [Reading Notes: *Digitial Image Processing, 4th (DIP)*](https://blog.csdn.net/qq_32071849/article/details/103963394)
  + [Reading Notes: *Computer System - A Programmer's Perspective, 3rd (CSAPP)*](https://blog.csdn.net/qq_32071849/article/details/111652211?spm=1001.2014.3001.5502)
  + [Reading Notes: *Introduction to Algorithms, 3rd (CLRS)*](https://blog.csdn.net/qq_32071849/article/details/124585221?spm=1001.2014.3001.5502)
